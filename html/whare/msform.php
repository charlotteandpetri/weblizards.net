  ...
  <table width="650" border="0" align="left" cellpadding="2" cellspacing="2" bgcolor="#FFFFFF">
    ...
    <tr>
      ...
      <td><table width="534"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="112">&nbsp;</td>
            <td width="69" class="question">State:</td>
            <td width="117">&nbsp;</td>
            <td width="43" class="question">Zip:</td>
            <td width="193">&nbsp;</td>
          </tr>
      </table></td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="2"><table width="100%"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td width="350" valign="top" class="question">What is your time frame for making
              a decision?</td>
            <td><input name="business_descr2" type="checkbox" id="business_descr2" value="dealer" <?php if ($_SESSION['business_descr'] == "dealer") { echo "checked=\"checked\""; } ?>>
              <span class="text">              immediately <br>
              <input name="business_descr3" type="checkbox" id="business_descr3" value="dealer" <?php if ($_SESSION['business_descr'] == "dealer") { echo "checked=\"checked\""; } ?>>
              under_3_mos <br>
              <input name="business_descr4" type="checkbox" id="business_descr4" value="dealer" <?php if ($_SESSION['business_descr'] == "dealer") { echo "checked=\"checked\""; } ?>>
              3-6_mos <br>
              <input name="business_descr5" type="checkbox" id="business_descr5" value="dealer" <?php if ($_SESSION['business_descr'] == "dealer") { echo "checked=\"checked\""; } ?>>
              6-12_mos </span></td>
          </tr>
      </table></td>
    </tr>
