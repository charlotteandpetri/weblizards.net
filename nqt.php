<?
#######################################################################
#nqt.php last revised    05/07/03 (http://www.shat.net/php/nqt/)      #
#        Initial release 03/11/01                                     # 
#        NQT is now more than two years old and still in wide use!    #
#                                                                     #
#Version 1.6                                                          #
...
#                                                                     #
#COPYRIGHT shaun@shat.net - If you use this script, the copyright     #
#notice appended to query results MUST remain INTACT and UNALTERED,   #
#including the link to the distribution site http://shat.net/php/nqt/ #
#This script is FREE SOFTWARE, but you may NOT claim it as your own.  #
#                                                                     #
...
<hr>
<p align="right"><font face="verdana,arial" size=1 color="#ffffff">NQT20030507 <a href="http://shat.net/php/nqt/"><font color="#cccccc">Network Query Tool 1.6</a><br>Copyright 2003 shaun@shat.net</font></p>
